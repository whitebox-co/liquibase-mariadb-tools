...
public class MariaDbToolsToolkitVersion {

    private final int major;
    private final int minor;
    private final int patch;

    public MariaDbToolsToolkitVersion(String version) {
        if (version == null) {
            major = 0;
            minor = 0;
            patch = 0;
    ...
    public boolean isGreaterOrEqualThan(String otherVersion) {
        MariaDbToolsToolkitVersion other = new MariaDbToolsToolkitVersion(otherVersion);
