...
public class MariaDbToolsCreateIndexChangeTest extends AbstractMariaDbToolsChangeTest<MariaDbToolsCreateIndexChange> {

    public MariaDbToolsCreateIndexChangeTest() {
        super(MariaDbToolsCreateIndexChange.class);
    }

    @Override
    protected void setupChange(MariaDbToolsCreateIndexChange change) {
